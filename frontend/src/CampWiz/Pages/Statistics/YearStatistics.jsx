...
const column2 = [
    {field : 'color', headerName : 'Color', align : 'center', headerAlign : 'center', minWidth : 70, sortable : false, renderCell : (params) => <span style={{backgroundColor : params.value, width : '100%', height : '100%'}}></span>},
